...
export const metadata: Metadata = {
  ...
  description:
    "구호가 아닌 데이터로. 서울 5호선 김포·검단 연장은 확정됐습니다. 감정~장기 4.2km 무정차 구간에 김포경찰서역 신설을 공공데이터로 촉구하는 정치적 중립 시민 플랫폼입니다.",
  keywords: [
    "5호선 김포연장",
    "김포경찰서역",
    "김포한강선",
  ...
  openGraph: {
    ...
    description:
      "본선은 확정됐다, 이제 역이다. 감정~장기 4.2km 무정차 구간에 김포경찰서역 신설을 공공데이터로 촉구하는 시민 플랫폼.",
    images: [
      {
        url: "/og.png",
        width: 1200,

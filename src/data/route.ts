...
export const LINE_FACTS = [
  ...
  { label: "총사업비", value: "3조7,511", unit: "억원", tone: "brand" as const, sub: "예타 통과 기준 · 백서 p.97" },
 ...
 *
 * 총사업비는 백서 p.97 기준 3조7,511억원을 씁니다. 같은 백서 p.101(서부권 광역급행철도)에도
 * 동일한 수치가 적혀 있어 한때 기재 오류를 의심했으나, p.97의 값이 정확한 것으로 확인했습니다.
 * (오히려 p.101 쪽이 잘못 옮겨 적힌 것으로 보입니다.)
 */
